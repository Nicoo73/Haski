...
/* package space-game-1.0 */
#ifndef VERSION_space_game
#define VERSION_space_game "1.0"
#endif /* VERSION_space_game */
#ifndef MIN_VERSION_space_game
#define MIN_VERSION_space_game(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_space_game */
...
#define CURRENT_COMPONENT_ID "space-game-1.0-inplace-game"
